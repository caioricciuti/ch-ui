    ...
    <>
              ...
              <TableCell className="text-right">
                <DropdownMenu>
                  ...
                  <DropdownMenuContent align="end">
                    ...
                    <DropdownMenuItem onClick={() => handleAddUserClick(cred)}>
                    ...
                    <DropdownMenuItem onClick={() => handleAddOrgClick(cred)}>
        ...
        <DialogContent>
          ...
          {usersNotInCredential.length === 0 && (
            <DialogDescription className="text-red-600 text-xs">
              There are no users available to add to this credential. All users
              are already assigned or no users exist in the system.
            </DialogDescription>
          )}
          <DialogFooter>
            <Button
      ...
      >
        <DialogContent>
          ...
          {usersInCredential.length === 0 && (
            <DialogDescription className="text-red-600 text-xs">
              There are no users to remove from this credential. The credential
      ...
      <Dialog open={addOrgDialogOpen} onOpenChange={setAddOrgDialogOpen}>
        <DialogContent>
          ...
          {orgsNotInCredential.length === 0 && (
            <DialogDescription className="text-red-600 text-xs">
              There are no organizations available to add to this credential.
              All organizations are already assigned or no organizations exist
              in the system.
            </DialogDescription>
          )}
          <DialogFooter>
      ...
      <Dialog open={removeOrgDialogOpen} onOpenChange={setRemoveOrgDialogOpen}>
        <DialogContent>
          <DialogHeader>
            <DialogTitle>Remove Organization from Credential</DialogTitle>
            <DialogDescription>
              Select an organization to remove from "{credentialToManage?.name}
              ".
            </DialogDescription>
          </DialogHeader>
          <Select onValueChange={setSelectedOrgId} value={selectedOrgId}>
